...
edgespec_meas2: dict[BoundarySide, EdgeSpecValue] = {BoundarySide.LEFT: EdgeSpecValue.X, BoundarySide.RIGHT: EdgeSpecValue.X, BoundarySide.TOP: EdgeSpecValue.Z, BoundarySide.BOTTOM: EdgeSpecValue.X}
...
edgespec_pipe_XZ: dict[BoundarySide, EdgeSpecValue] = {BoundarySide.LEFT: EdgeSpecValue.O, BoundarySide.RIGHT: EdgeSpecValue.O, BoundarySide.TOP: EdgeSpecValue.Z, BoundarySide.BOTTOM: EdgeSpecValue.O}
...
blocks = [
    ...
    (PatchCoordGlobal3D((1, 0, 4)), MemoryCubeSkeleton(d=d, edgespec=edgespec_LEFT0_BOTTOMX)),
