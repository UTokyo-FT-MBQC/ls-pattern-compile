...
canvass = RHGCanvasSkeleton("Corner Node Elimination Test")
...
edgespec_inv: dict[BoundarySide, EdgeSpecValue] = {
...
edgespec_LEFT0: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.X,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.Z,
}
edgespec_RIGHT0: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.X,
...
edgespec_LEFT0_BOTTOMX: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.X,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.X,
...
edgespec_LEFT0_BOTTOMX_RIGHTZ: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.Z,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.X,
...
edgespec_meas2: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.X,
    BoundarySide.RIGHT: EdgeSpecValue.X,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.X,
...
edgespec_pipe: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.O,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.Z,
}
edgespec_pipe_XZ: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.O,
    BoundarySide.TOP: EdgeSpecValue.Z,
    BoundarySide.BOTTOM: EdgeSpecValue.O,
}
edgespec_pipe_measure: dict[BoundarySide, EdgeSpecValue] = {
    BoundarySide.LEFT: EdgeSpecValue.O,
    BoundarySide.RIGHT: EdgeSpecValue.O,
...
blocks = [
    ...
    (
        ...
        MemoryCubeSkeleton(d=d, edgespec=edgespec_RIGHT0, next_edgespec=edgespec_RIGHT0),
    ),
    (
        PatchCoordGlobal3D((1, 0, 2)),
        MemoryCubeSkeleton(d=d, edgespec=edgespec_LEFT0, next_edgespec=edgespec_LEFT0_BOTTOMX),
    ),
    # Clock 3
    (PatchCoordGlobal3D((0, 0, 3)), MemoryCubeSkeleton(d=d, edgespec=edgespec_RIGHT0)),
    (
        PatchCoordGlobal3D((1, 0, 3)),
        MemoryCubeSkeleton(d=d, edgespec=edgespec_LEFT0_BOTTOMX),
    ),
    # Clock 4
    ...
    (
        ...
        MeasureXSkeleton(d=d, edgespec=edgespec_meas2, disable_cout=True),
    ),
]
...
pipes = [
    ...
    (
        ...
        PatchCoordGlobal3D((1, 0, 3)),
        MemoryPipeSkeleton(d=d, edgespec=edgespec_pipe_XZ),
    ),
    (
...
#         PatchCoordGlobal3D((0, 0, 5)),
#         PipeCoordGlobal3D(
#             (PatchCoordGlobal3D((0, 0, 5)), PatchCoordGlobal3D((1, 0, 5)))
#         ),
#     }
# }
# logical_observables = {}
...
#             and len(coord) == 2
#             and all(isinstance(c, tuple) for c in coord)
#         ):  # isinstance cannot be used with NewType
...
#     # set(node) or 697 is logical observable
#     logical_observables[i] = set(nodes).union({697, 269, 257})
...
#     compiled_canvas, show_edges=True, hilight_nodes=logical_observables[0]
# )
# fig3d.show()
