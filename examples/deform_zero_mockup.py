...
blocks = [
    ...
    (PatchCoordGlobal3D((1, 0, 1)), InitZeroCubeThinLayerSkeleton(d=d, edgespec=edgespec)),
    ...
    (PatchCoordGlobal3D((1, 0, 4)), MeasureZSkeleton(d=d, edgespec=edgespec)),
]
...
noise = 0.001
coord2logical_group = {
    0: {PatchCoordGlobal3D((1, 0, 4)), PipeCoordGlobal3D((PatchCoordGlobal3D((0, 0, 2)), PatchCoordGlobal3D((1, 0, 2))))},
}
logical_observables = {}
...
pathlib.Path("figures/deform_zero_dem.svg").write_text(str(svg), encoding="utf-8")
print("SVG diagram saved to figures/deform_zero_dem.svg")
